    ...
    <section id="about">
      <div className="section-container">
        ...
        <div className="margin-horizontal body-text">
          <p className="spacer readable-background-light">
          ...
          <p className="readable-background-dark">
          Conceivably, the creator of pained smiles, earth tones' 2024 EP, has something of a melancholic relationship to music— as any classical violinist that gets their start in their teens tends to have, from not-enough to too-much. Perhaps it's therapeutic, or maybe it's just the glorified act of digging your nails into a still-bleeding wound. To listen to pained smiles is to peer within their naked heart, from the painfully vulnerable and intimate lyricism to the sultry, delicate exploration of self. Now having released pained smiles, earth tones finds themself shackled and liberated, simultaneously, by their quiet, controlled fierceness, fervent dedication to music, and— most of all— their Capricorn stellium.
          </p>
        </div>
    </div>
  </section>
